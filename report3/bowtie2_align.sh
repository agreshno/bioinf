...
#SBATCH --output=bowtie2_align_output
...
srun bowtie2 -x DrosoGenome -U SRR869918_trimmed.fq -p 8 -S SRR869918.sam

srun bowtie2 -x DrosoGenome -U SRR869919_trimmed.fq -p 8 -S SRR869919.sam

srun bowtie2 -x DrosoGenome -U SRR869920_trimmed.fq -p 8 -S SRR869920.sam

srun bowtie2 -x DrosoGenome -U SRR869921_trimmed.fq -p 8 -S SRR869921.sam
