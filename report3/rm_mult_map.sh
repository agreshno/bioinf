...
srun grep -v 'XS:i:' SRR859218.sam > SRR859218.sam

srun grep -v 'XS:i:' SRR859219.sam > SRR859219.sam

srun grep -v 'XS:i:' SRR859220.sam > SRR859220.sam

srun grep -v 'XS:i:' SRR859221.sam > SRR859221.sam
